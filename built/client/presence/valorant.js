...
exports.formatValorantPresence = void 0;
const formatValorantPresence = (presence) => {
    const { st, 's.t': timestamp, 's.d': unknown1, 's.l': unknown2, m, 's.a': unknown3, p, 's.p': presenceType, ...other } = presence;
    const presenceObj = new Object({
        status: st,
        statusMessage: m,
        timestamp,
...
exports.formatValorantPresence = formatValorantPresence;
